...
public class MapleWoodBlock extends PillarBlock {

    public MapleWoodBlock(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (itemStack.getItem() instanceof AxeItem) {
            if (!world.isClient) {
                ...
                world.setBlockState(pos, ModBlocks.STRIPPED_MAPLE_WOOD.getDefaultState().with(Properties.AXIS, state.get(Properties.AXIS)), 11);
            }
