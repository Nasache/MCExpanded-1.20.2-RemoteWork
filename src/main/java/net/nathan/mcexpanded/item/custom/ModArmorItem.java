...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>()
                    .put(ArmorMaterials.LEATHER, new StatusEffectInstance(ModEffects.LEATHER, 1, 0, false, false, true))
                    .put(ArmorMaterials.CHAIN, new StatusEffectInstance(ModEffects.CHAIN, 1, 0, false, false, true))
                    .put(ModArmorMaterials.HONEY, new StatusEffectInstance(ModEffects.BEE, 1, 0, false, false, true))
                    .put(ModArmorMaterials.SLIME, new StatusEffectInstance(ModEffects.SLIMEY, 1, 0, false, false, true))
                    .put(ModArmorMaterials.PRISMARINE, new StatusEffectInstance(ModEffects.PRISMARINE, 1, 0, false, false, true)).build();
